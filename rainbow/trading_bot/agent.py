...
class Agent:
    ...
    def train_experience_replay(self, batch_size):
        ...
        #print('se entrena el self.model')
        loss = self.model.fit(
    ...
    def save(self):
        #print("models/{}_{}".format(self.model_name, episode))
        self.model.save("models/{}".format(self.model_name),include_optimizer=True)

    def load(self, manual):
        if manual:
            return load_model( 'models/' + self.model_name,custom_objects={'NoisyDense': NoisyDense})
            #return load_model('models/{}.h5'.format(self.model_name))
        else:
            return load_model( 'C:/Users/eduar/PycharmProjects/Comparacion_memoria/rainbow/models/{}'.format(self.model_name),custom_objects={'NoisyDense': NoisyDense})
            #return load_model('rainbow/models/{}.h5'.format(self.model_name))